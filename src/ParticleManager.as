package  
{
	...
	public class ParticleManager 
	{
		...
		{
			this.solver = solver;
			this.particlesPerBatch = particlesPerBatch * 4;
		...
		public function update(bmp:BitmapData, lines:Boolean):void
		{
			...
			while (p)
			{
				...
				vec[batchCount][particleCount++] = int(p.alpha*10000)/10000;
				//vec[batchCount][particleCount++] = (particleCount - 4) / (particlesPerBatch);
				
				if (particleCount >= particlesPerBatch) {
					particleCount = 0;
					batchCount++;
